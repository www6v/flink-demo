...
class JoinLeaveDBSink extends SinkFunction[((String,String,  String,Long, Long, Long, Boolean, Integer,Integer,Integer),
  (String,String,String, Integer, Long, String, String, String, String, String, String,Integer, String))] {
  override def invoke(value: ((String, String,  String, Long, Long, Long, Boolean, Integer,Integer,Integer),
